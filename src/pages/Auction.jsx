...
//   const highestPrice = bidList.reduce((maxPrice, bid) => {
//     return bid.price > maxPrice ? bid.price : maxPrice;
//   }, currentPrice);
...
//   // Định danh của tài liệu (id đã có sẵn)
// const documentId = {id};

// // Tham chiếu đến tài liệu trong Firestore
// const documentRef = firestoreApp.collection('bidwin').doc(documentId);
...
//             </div>
//           )}
//           <div className=' auction min-h-[346px] shadow-lg p-3 rounded flex gap-5 justify-center'>
